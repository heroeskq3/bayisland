...
if ($qacustomerslist['rows']) {
    foreach ($qacustomerslist['response'] as $row_qacustomerslist) {
        ...
        //context
        $context     = class_qacustomerscontext($row_qacustomerslist['CreateDate'], $row_qacustomerslist['LastVisit'], $row_qaclassesinfo['Period'], 365);
        ...
        $array_qacustomerslist[] = array(
            ...
            'Fecha de Creación'      => $row_qacustomerslist['CreateDate'],
            'Fecha de Ultima Visita' => $row_qacustomerslist['LastVisit'],
