...
if ($form_update) {
    ...
    $qacustomersupdate = class_qaCustomersUpdate($Id, $CategoryId, $UsersId, $ClassesId, $FullName, $Phone, $Phone2, $Contact, $Mobile, $Email, $Email2, $Email3, $Email4, $Email5, $Country, $State, $City, $Address, $Status);

    //set activity
    if ($qacustomersupdate['rows']) {
        $Details = 'Ver detalles en el sistema';
        class_qaActivityAdd($UsersId, 'qa_customers', $Id, 'Cliente Modificado', $Details, 2);
    }
