	...
	<div class="col-lg-12">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-xs-12 col-md-6 col-xs-12 col-sm-12">
						...
						<form id="validationForm" role="form" action="<?php echo $formParams['action']; ?>"
						 method="<?php echo $formParams['method']; ?>" enctype="<?php echo $formParams['enctype']; ?>">
							<?php }?>
        ...
        ?>
							<div class="form-group">
								...
								<label>
									<?php echo $label; ?>
									<a href="<?php echo $_SERVER['PHP_SELF'] . '?action=' . $row['name']; ?>">(Agregar)</a>
								</label>
								<?php } else {?>
								<label>
									<?php echo $label; ?>
