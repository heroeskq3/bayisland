...
function class_reportsFilterBar($array)
{
    $results = null;
    if ($array) {
        ...
        foreach ($array_key as $key) {
            ...
            if (($key !== 'index') && ($key !== 'childs') && ($key !== 'context') && ($key !== 'status')) {
        ...
        if ($array_field) {
            ...
            $array_resume[] = array('label' => 'Semanal', 'value' => 'Week', 'selected' => $resume);
            $array_resume[] = array('label' => 'Ficha', 'value' => 'Info', 'selected' => $resume);
        }
