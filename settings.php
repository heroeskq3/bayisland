                                ...
                                <form class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group pmd-textfield">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control empty" id="inputEmail" value="<?php echo $row_usersInfo['FirstName']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group pmd-textfield">
                                            <label class="col-sm-3 control-label" for="u_fname">Last Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control empty" id="inputEmail" value="<?php echo $row_usersInfo['LastName']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group pmd-textfield">
                                            <label class="col-sm-3 control-label" for="u_fname">Email</label>
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control empty" value="<?php echo $row_usersInfo['Email']; ?>" id="inputEmail" placeholder="">
                                            </div>
                                        </div>
