...
define('CONFIG_LOGOICON', 'logo-bayisland.png');
define('CONFIG_LOGOHEADER', 'logo-bayisland.png');
define('CONFIG_LOGOHEADER2', 'logo-bayisland2.png');
define('CONFIG_LOGOHEADER3', 'logo-bayisland.png');
define('CONFIG_LOGOFOOTER', null);
define('CONFIG_FOOTER', '© 2018 Todos los Derechos Reservados');
define('CONFIG_SUPPORTPHONE', '2222-0000');
define('CONFIG_SUPPORTEMAIL', 'info@bayisland.com');
define('CONFIG_LICENSEDUNDER', 'http://www.bayisland.com');
...
define('CONFIG_MYSQLDB', 'bayisland4');
